 ...
 */
public class KingbaseESType {

    public static final KingbaseESType UNKNOWN = new KingbaseESType("unknown", -1, Integer.MIN_VALUE, null, null, null, null);

    private final String name;
    private final int oid;
    private final int jdbcId;
    private final KingbaseESType parentType;
    private final KingbaseESType elementType;
    private final TypeInfo typeInfo;
    private final int modifiers;
    private final List<String> enumValues;

    private KingbaseESType(String name, int oid, int jdbcId, TypeInfo typeInfo, List<String> enumValues, KingbaseESType parentType, KingbaseESType elementType) {
        this(name, oid, jdbcId, TypeRegistry.NO_TYPE_MODIFIER, typeInfo, enumValues, parentType, elementType);
    }

    private KingbaseESType(String name, int oid, int jdbcId, int modifiers, TypeInfo typeInfo, List<String> enumValues, KingbaseESType parentType,
                           KingbaseESType elementType) {
     ...
     */
    public KingbaseESType getElementType() {
        return elementType;
    }
     ...
     */
    public KingbaseESType getParentType() {
        return parentType;
    }
     ...
     */
    public KingbaseESType getRootType() {
        KingbaseESType rootType = this;
    ...
    public boolean equals(Object obj) {
        ...
        KingbaseESType other = (KingbaseESType) obj;
        if (oid != other.oid) {
            return false;
        }
        return true;
    ...
    public String toString() {
        return "KingbaseESType [name=" + name + ", oid=" + oid + ", jdbcId=" + jdbcId + ", modifiers=" + modifiers + ", defaultLength=" + getDefaultLength()
    ...
    public static class Builder {
        ...
        public KingbaseESType build() {
            KingbaseESType parentType = null;
            if (this.hasParentType()) {
                parentType = typeRegistry.get(parentTypeOid);
            }

            KingbaseESType elementType = null;
            if (elementTypeOid != 0) {
                elementType = typeRegistry.get(elementTypeOid);
            }

            return new KingbaseESType(name, oid, jdbcId, modifiers, typeInfo, enumValues, parentType, elementType);
        }
    }
}
