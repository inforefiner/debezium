...
public class ColumnMetaData {
    ...
    private final KingbaseESType postgresType;
     ...
     */
    ColumnMetaData(String columnName, KingbaseESType postgresType, boolean key, boolean optional, boolean hasDefaultValue, Object defaultValue, int typeModifier) {
    ...
    public KingbaseESType getPostgresType() {
        return postgresType;
    }
