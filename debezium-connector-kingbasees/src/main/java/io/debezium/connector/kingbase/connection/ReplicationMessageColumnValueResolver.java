...
import io.debezium.connector.kingbase.connection.ReplicationMessage.ColumnValue;
...
public class ReplicationMessageColumnValueResolver {
     ...
     * @return
     */
    public static Object resolveValue(String columnName, KingbaseESType type, String fullType, ColumnValue value, final PgConnectionSupplier connection,
        ...
        switch (type.getName()) {
            ...
            case "money":
                ...
                return (v instanceof KBmoney) ? ((KBmoney) v).val : v;
            case "path":
                return value.asPath();
            case "point":
