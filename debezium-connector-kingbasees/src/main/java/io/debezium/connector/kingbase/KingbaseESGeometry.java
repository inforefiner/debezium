 ...
 * @author Robert Coup
 */
public class KingbaseESGeometry {
     ...
     */
    public static KingbaseESGeometry fromHexEwkb(String hexEwkb) {
     ...
     * SRID is extracted from the EWKB
     */
    public static KingbaseESGeometry fromEwkb(byte[] ewkb) {
        return new KingbaseESGeometry(ewkb, parseSrid(ewkb));
    }

    /**
     * Create a GEOMETRYCOLLECTION EMPTY PostgisGeometry
     *
     * @return a {@link KingbaseESGeometry} which represents a PostgisGeometry API
     */
    public static KingbaseESGeometry createEmpty() {
        return KingbaseESGeometry.fromHexEwkb(HEXEWKB_EMPTY_GEOMETRYCOLLECTION);
    }
     ...
     */
    private KingbaseESGeometry(byte[] ewkb, Integer srid) {
        this.wkb = ewkb;
        this.srid = srid;
    }
