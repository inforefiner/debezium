...
public abstract class AbstractReplicationMessageColumn implements ReplicationMessage.Column {
    ...
    public static class TypeMetadataImpl implements ReplicationMessage.ColumnTypeMetadata {
        ...
        public TypeMetadataImpl(String columnName, KingbaseESType type, String typeWithModifiers, boolean optional) {
    ...
    private final KingbaseESType type;

    public AbstractReplicationMessageColumn(String columnName, KingbaseESType type, String typeWithModifiers, boolean optional, boolean hasMetadata) {
        super();
    ...
    /**
     * @return the {@link KingbaseESType} containing both OID and JDBC id.
     */
    @Override
    public KingbaseESType getType() {
        return type;
    }
