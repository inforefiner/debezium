...
/**
 * Represents a toasted column in a {@link io.debezium.connector.kingbase.connection.ReplicationStream}.
 * <p>
 ...
 * a {@link io.debezium.connector.kingbase.connection.ReplicationMessage}.
 *
...
public class UnchangedToastedReplicationMessageColumn extends AbstractReplicationMessageColumn {
    ...
    public UnchangedToastedReplicationMessageColumn(String columnName, KingbaseESType type, String typeWithModifiers, boolean optional, boolean hasMetadata) {
    ...
    @Override
    public Object getValue(KingbaseESStreamingChangeEventSource.PgConnectionSupplier connection, boolean includeUnknownDatatypes) {
