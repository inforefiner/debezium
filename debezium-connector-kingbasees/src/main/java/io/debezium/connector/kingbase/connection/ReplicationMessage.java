...
import io.debezium.connector.kingbase.KingbaseESStreamingChangeEventSource;
...
public interface ReplicationMessage {
    ...
    public interface ColumnValue<T> {
        ...
        boolean isArray(KingbaseESType type);

        Object asArray(String columnName, KingbaseESType type, String fullType, PgConnectionSupplier connection);
     ...
     * Enables {@link KingbaseESStreamingChangeEventSource} to advance LSN forward even in case of such messages.
     */
