...
public abstract class RecordsProducer {
    ...
    protected final KingbaseESTaskContext taskContext;
    protected final SourceInfo sourceInfo;

    protected RecordsProducer(KingbaseESTaskContext taskContext, SourceInfo sourceInfo) {
    ...
    /**
     * Starts up this producer. This is normally done by a {@link KingbaseESConnectorTask} instance. Subclasses should start
    ...
    /**
     * Requests that this producer be stopped. This is normally a request coming from a {@link KingbaseESConnectorTask} instance
     */
