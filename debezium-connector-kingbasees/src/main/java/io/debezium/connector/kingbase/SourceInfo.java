 ...
 *
 * <p>
 * The {@link # source partition} information describes the database server for which we're streaming changes.
 ...
 *
 * <p>
 * The {@link # source offset} information describes a structure containing the position in the server's WAL for any
 ...
 * <p>
 * The {@link # source} struct appears in each message envelope and contains information about the event. It is
 * a mixture the fields from the {@link # partition} and {@link # offset}.
...
public final class SourceInfo extends BaseSourceInfo {
    ...
    protected SourceInfo(KingbaseESConnectorConfig connectorConfig) {
