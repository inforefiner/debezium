...
public class KingbaseESOffsetContext implements OffsetContext {
    ...
    private KingbaseESOffsetContext(KingbaseESConnectorConfig connectorConfig, Lsn lsn, Lsn lastCompletelyProcessedLsn, Lsn lastCommitLsn, Long txId, Instant time,
                                    boolean snapshot,
    ...
    public static class Loader implements OffsetContext.Loader<KingbaseESOffsetContext> {

        private final KingbaseESConnectorConfig connectorConfig;

        public Loader(KingbaseESConnectorConfig connectorConfig) {
        ...
        @Override
        public KingbaseESOffsetContext load(Map<String, ?> offset) {
            ...
            return new KingbaseESOffsetContext(connectorConfig, lsn, lastCompletelyProcessedLsn, lastCommitLsn, txId, useconds, snapshot, lastSnapshotRecord,
    ...
    public static KingbaseESOffsetContext initialContext(KingbaseESConnectorConfig connectorConfig, KingbaseESConnection jdbcConnection, Clock clock) {
        return initialContext(connectorConfig, jdbcConnection, clock, null, null);
    }

    public static KingbaseESOffsetContext initialContext(KingbaseESConnectorConfig connectorConfig, KingbaseESConnection jdbcConnection, Clock clock, Lsn lastCommitLsn,
                                                         Lsn lastCompletelyProcessedLsn) {
        try {
            ...
            return new KingbaseESOffsetContext(
                    connectorConfig,
                    lsn,
