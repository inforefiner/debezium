 ...
 */
@ThreadSafe
class KingbaseESDefaultValueConverter {

    private static Logger LOGGER = LoggerFactory.getLogger(KingbaseESDefaultValueConverter.class);
    ...
    private final KingbaseESValueConverter valueConverters;
    private final Map<String, DefaultValueMapper> defaultValueMappers;

    KingbaseESDefaultValueConverter(KingbaseESValueConverter valueConverters, TimestampUtils timestampUtils) {
    ...
    private static Map<String, DefaultValueMapper> createDefaultValueMappers(TimestampUtils timestampUtils) {
        ...
        result.put("interval", v -> new KBInterval(extractDefault(v, "epoch")));
