...
class Wal2JsonReplicationMessage implements ReplicationMessage {
    ...
    private List<Column> transform(final Document data, final String nameField, final String typeField, final String valueField,
        ...
        for (int i = 0; i < columnNames.size(); i++) {
            ...
            final KingbaseESType columnType = typeRegistry.get(parseType(columnName, columnTypeName));
     ...
     * {@link KingbaseESValueConverter#(Column, Field)} instance to match whatever the Connect schema type expects.
     * <p>
     ...
     */
    public Object getValue(String columnName, KingbaseESType type, String fullType, Value rawValue, final PgConnectionSupplier connection,
