...
public interface ReplicationConnection extends AutoCloseable {
     ...
     *               is {@code null} or negative, this behaves exactly like .
     * @return a {@link KBReplicationStream} from which data is read; never null
     ...
     *
     * @param config a {@link KingbaseESConnectorConfig} instance; may not be null
     * @return a builder, never null
     */
    static Builder builder(KingbaseESConnectorConfig config) {
        return new KingbaseESReplicationConnection.ReplicationConnectionBuilder(config);
    }
    ...
    interface Builder {
         ...
         * @return this instance
         */
        Builder withPublicationAutocreateMode(final KingbaseESConnectorConfig.AutoCreateMode publicationAutocreateMode);
         ...
         * @return this instance
         */
        Builder withPlugin(final KingbaseESConnectorConfig.LogicalDecoder plugin);
         ...
         * @return this instance
         */
        Builder withTruncateHandlingMode(final KingbaseESConnectorConfig.TruncateHandlingMode truncateHandlingMode);
         ...
         * @return this instance
         */
        Builder withSchema(KingbaseESSchema schema);
